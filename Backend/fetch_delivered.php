...
$sql = "SELECT 
    ...
    useraddress.*,
    useraddress.GSTIN AS customerGSTIN,
    products.*  
FROM 
    checkout
JOIN 
...
JOIN 
    ...
    WHERE 
    checkout.order_status = 'Delivered' AND checkout.shipping_status= 'Shipped' AND checkout.payment_status = 'Success' AND checkout.order_status != 'Cancelled'
     GROUP BY 
