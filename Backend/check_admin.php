...
header("Access-Control-Allow-Origin: https://www.waltzify.com");
...
// Fix the SQL query
$sql = "SELECT email, name FROM admin WHERE email = ?";
...
if ($result->num_rows > 0) {
    ...
    $_SESSION['adminEmail'] = $userEmail['email'];  // Fix session variable name
    ...
    try {
        ...
        $mail->Body    = '<strong>Dear Admin</strong>, <br> We have received your request for forgot password.<br>Your OTP code for password verification is - <b>' . $otp . '</b>. Your OTP will expire within 2 minutes. Please do not share this OTP with anyone.<br><p>If you have any problem or query, do not hesitate to contact us.<br>Thank You!<br><p>Best Regards,<br><b>Waltzify</b><br> Mob: +91 9522582422</p>
