...
JOIN 
    ...
    WHERE 
     (checkout.trackingURL != '' OR checkout.trackingId != '' OR checkout.invoiceNo != '' OR checkout.courier_company != '') AND checkout.order_status != 'Cancelled' AND checkout.shipping_status != 'Cancelled' AND checkout.payment_status != 'Cancelled' AND checkout.payment_status != 'COD Payment Not Received'
     GROUP BY 
