...
JOIN 
    ...
    WHERE 
     (checkout.trackingId = '' AND checkout.trackingURL = '' AND checkout.courier_company = '')AND checkout.order_status != 'Cancelled' AND checkout.shipping_status != 'Cancelled' AND checkout.shipping_status != 'Pending' AND checkout.payment_status != 'Cancelled'
     GROUP BY 
