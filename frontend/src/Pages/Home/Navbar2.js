    ...
    return (
        <div className='bg-[#F3F4F6] sticky top-0 z-[1000]'>
            <div className='flex justify-between items-center mx-[1rem] lg:mx-[5rem] border-b-2 h-[6rem]'>
                <Link to={'/'}><img className='lg:w-[9rem] sm:w-[12rem] w-[7rem] h-[5.5rem] lg:h-[7.5rem] object-contain ' src={require('../../asset/logo.png')} alt="logo" /></Link>
                <div className='gap-[1rem] flex flex-col-reverse lg:flex-row lg:w-[65rem] justify-evenly items-center'>
                    <div className='relative flex justify-between items-center bg-orange-500 rounded-2xl pl-[1px] lg:pr-[1rem] py-1 w-[13rem] lg:w-[35rem]'>
                        <input
                            ...
                            type="text"
                            placeholder='Search..'
                            className='rounded-2xl lg:text-xl py-1 px-[1rem] outline-none w-[80%] sm:px-[4px] lg:w-[31rem] ml-[.3rem] md:w-[10rem] sm:w-[10rem] '
                        />
                    ...
                    <div className='flex gap-[1rem] lg:text-xl md:text-md sm:text-sm'>
                        <Link to={'/cart'}>
                            {/* <div className='relative flex items-center gap-2'>
                              ...
                              <div className='relative flex items-center gap-2'>
                                ...
                                {/* edit */}
                                <p className='lg:block hidden text-sm lg:text-lg'>Cart</p>
                                <p className='absolute top-[-7px] left-4 text-white bg-red-500 px-[5px] py-[1px] text-xs rounded-[50%] sm:max-sm:px-[0px]'>{cartItems.length}</p>
                            </div>
                        </Link>
                        <Link to={'/wish'}>
                            {/* <div className='relative flex items-center gap-2'>
                                ...
                                <p className='absolute top-[-7px] left-4 text-white bg-red-500 p-1 text-xs rounded-[50%]'>{wishItems.length}</p>
                            </div> */}
                             <div className='relative flex items-center gap-2'>
                                {/* edit */}
                        ...
                        {isAuthenticated && (
                            ...
                            <div className='items-center gap-2 lg:flex'>
                                 ...
                                 <WavingHandIcon  className="waving-hand-icon" style={{ fontSize: 28 }}  />
                            </div>
                        ...
                        <div className='relative'>
                            <div className='flex items-center gap-2'>
                                < Person2OutlinedIcon />
                                <p onMouseOver={() => setShowAccountDropdown(true)} className='cursor-pointer text-sm lg:text-lg'>
                                    <p className='text-sm lg:text-lg font-bold xs:text-xs'>Hello,{user ? user.name.trim().slice(0, 6) : 'User'}</p>
                                    </p>
