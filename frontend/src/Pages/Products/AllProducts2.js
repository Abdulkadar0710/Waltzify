...
function AllProducts() {
    ...
    useEffect(() => {
        fetch('https://www.walt`zify.com/Backend/fetch_all_products.php')
        ...
        <div className={`${filter? ' opacity-50':''}`}>
            ...
            <div className='pb-[2rem] px-[2rem]'>
                ...
                <div className='lg:w-4/5'>
                    <div className='px-2 lg:px-[2.5rem] py-[2rem] grid gap-[1rem] lg:grid-cols-4 grid-cols-2 items-center justify-between lg:gap-5'>
