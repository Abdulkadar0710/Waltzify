            ...
            <div className={`absolute flex justify-evenly p-[1rem] w-[90vw] top-0 z-[10] bg-white text-black transition-transform ease-in-out duration-500 transform ${slide ? 'translate-x-0' : '-translate-x-full'}`}>
                <div className=''>
                    <div className=' flex justify-between items-center bg-orange-500 rounded-2xl pl-[1px] gap-2 pr-4 py-1 mr-2'>
                        <input className='rounded-2xl lg:text-xl outline-none w-[13rem] px-2 py-1 text-black' value={searchTerm} type="text" onChange={handleInputChange} placeholder='Search..'/>
...
{/*                     <div className='pb-[2rem] px-[2rem]'>
                ...
                <div className='lg:w-4/5 overflow-hidden'>
                    <div className='px-3 lg:px-[2.5rem] py-[2rem] grid gap-[1rem] lg:grid-cols-4 grid-cols-2 items-center justify-between lg:gap-5'>
                        {displayedProducts.map((product, index) => {
                            ...
                            >
                                <div className='shadow-xl hover:border-orange-500 group p-1 w-[9rem] lg:w-[17rem] lg:p-[1rem] border-2 rounded-xl cursor-pointer lg:h-[23rem]'>
                                    ...
                                    <img className='w-[9rem] h-[7rem] lg:h-[11rem] p-[1rem] lg:w-full rounded-xl' src={`http://localhost/waltzify_copy_fake/Backend/Products/${product.img1}`} alt="" />
