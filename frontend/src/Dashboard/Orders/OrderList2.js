...
/*     const handleCheckboxChange = (orderId) => {
   ...
   /*  const handleCheckboxChange = (orderId) => {
    ...
    const handleBulkAction = (action) => {
        ...
        else if(action === 'exportReadyToShip'){
            exportShippingDetails(selectedOrders);
        }
    };
   ...
   const exportShippingDetails = () => {
    ...
    const data = [
        ['Order ID', 'Tracking ID', 'Invoice No', 'Courier Company', 'Courier Charges']
    ];
        ...
        <tbody>
            {Object.keys(groupedOrders)
                .filter((orderId) => {
                    ...
                    // Filter by presence of invoiceNumber, trackingId, awbNumber, courierCompany, or courierCharges
                    const hasRequiredFields = !!(order.invoiceNo?.trim() || order.trackingId?.trim() || order.courier_company?.trim() || order.courier_charges);
